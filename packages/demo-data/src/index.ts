...
// Demo org aggregate (used for org-mode widgets when Data Mode = demo).
// This intentionally represents a "healthy" 100-member community.
export const demoOrgAggregateTradeIdeaAnalyticsSummary = {
  sampleSize: 12_400,
  closedTrades: 12_800,
  openTrades: 97,
  totalFees: 3_240.5,
  totalPnl: 184_520.75,
  memberCountTotal: 100,
  memberCountConsidered: 100,
  isTruncated: false,
} as const;

export const demoOrgTradingPlanCumulativeSummary = {
  sampleSize: 10_250,
  closedTrades: 10_480,
  openTrades: 84,
  totalFees: 2_910.75,
  totalPnl: 162_880.25,
  memberCountTotal: 100,
  memberCountEligible: 100,
  memberCountConsidered: 100,
  isTruncated: false,
} as const;

export const demoOrgTradingPlanLeaderboard = [
  {
    userId: "demo-user-01",
    name: "Alex Rivera",
    image: null,
    planId: "demo-org-plan-1",
    sampleSize: 420,
    closedTrades: 440,
    openTrades: 2,
    totalFees: 118.2,
