...
import { ChevronIcon } from "@convexcms/ui";
...
const Bracket = ({
  ...
  const rightBracket =
    type === "object" ? chars.rightCurlyBracket : chars.rightSquareBracket;
  const leftBracket =
    type === "object" ? chars.leftCurlyBracket : chars.leftSquareBracket;
