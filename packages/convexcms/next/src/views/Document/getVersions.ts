...
import { combineQueries, extractAccessFromPermission } from "@convexcms/core";
import { sanitizeID } from "@convexcms/ui/shared";
...
export const getVersions = async ({
  ...
  const shouldFetchVersions = Boolean(
    versionsConfig && docPermissions?.readVersions,
  );
