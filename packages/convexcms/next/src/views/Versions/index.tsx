import type { DocumentViewServerProps, PaginatedDocs } from "@convexcms/core";
import React from "react";
import { notFound } from "next/navigation.js";
import { logError } from "@convexcms/core";
import { isNumber } from "@convexcms/core/shared";
import { Gutter, ListQueryProvider, SetDocumentStepNav } from "@convexcms/ui";
...
export async function VersionsView(props: DocumentViewServerProps) {
  ...
  if (collectionSlug) {
    ...
    const whereQuery: {
      and: Array<{
        parent?: { equals: number | string };
        snapshot?: { not_equals: boolean };
      }>;
    } = {
      and: [
        {
      ...
      <main className={baseClass}>
        <Gutter className={`${baseClass}__wrap`}>
          <ListQueryProvider
            ...
            modifySearchParams
            orderableFieldName={
              collectionConfig?.orderable === true ? "_order" : undefined
            }
          >
            <VersionsViewClient
              baseClass={baseClass}
