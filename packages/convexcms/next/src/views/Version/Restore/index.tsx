...
import { requests } from "@convexcms/ui/shared";
...
const Restore: React.FC<Props> = ({
  ...
  const canRestoreAsDraft =
    status !== "draft" && collectionConfig?.versions?.drafts;
  ...
  return (
    <Fragment>
      <div className={[baseClass, className].filter(Boolean).join(" ")}>
        <Button
          buttonStyle="pill"
          className={[canRestoreAsDraft && `${baseClass}__button`]
            .filter(Boolean)
            .join(" ")}
