...
describe("countChangedFields", () => {
  ...
  it("should count changed fields inside group fields", () => {
    ...
    const comparison = {
      group: { a: "original", b: "original", c: "original" },
    };
  ...
  it("should count changed fields inside named tabs ", () => {
    ...
    const comparison = {
      namedTab: { a: "original", b: "original", c: "original" },
    };
  ...
  it("should count changed fields inside arrays nested inside of collapsibles", () => {
    ...
    const comparison = {
      arrayField: [{ a: "original", b: "original", c: "original" }],
    };
    const version = {
      arrayField: [{ a: "changed", b: "changed", c: "original" }],
    };
  ...
  it("should count changed fields between blocks with different slugs", () => {
    ...
    const comparison = {
      blocks: [
        { blockType: "blockA", a: "removed", b: "original", c: "original" },
      ],
    };
    const version = {
    ...
    it("should count changed fields inside localized blocks fields", () => {
      ...
      const version = {
        blocks: {
          ...
          de: [
            { blockType: "blockA", a: "original", b: "changed", c: "original" },
          ],
        },
      };
      const result = countChangedFields({
