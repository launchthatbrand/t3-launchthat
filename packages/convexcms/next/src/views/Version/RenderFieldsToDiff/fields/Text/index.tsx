...
import type { TextFieldDiffClientComponent } from "@convexcms/core";
import React from "react";
import { getTranslation } from "@convexcms/translations";
import { FieldDiffLabel, useTranslation } from "@convexcms/ui";
...
export const Text: TextFieldDiffClientComponent = ({
  ...
  const versionToRender: string =
    typeof versionValue === "string"
      ? versionValue
      : JSON.stringify(versionValue, null, 2);
  const comparisonToRender =
    typeof comparisonValue === "string"
      ? comparisonValue
      : JSON.stringify(comparisonValue, null, 2);
