...
import type { FieldDiffClientProps } from "@convexcms/core";
import React from "react";
import { fieldIsArrayType, fieldIsBlockType } from "@convexcms/core/shared";
import { getTranslation } from "@convexcms/translations";
import { useConfig, useTranslation } from "@convexcms/ui";
...
export const Iterable: React.FC<FieldDiffClientProps> = ({
  ...
  const comparisonRowCount = Array.isArray(comparisonValue)
  ...
  if (!fieldIsArrayType(field) && !fieldIsBlockType(field)) {
    throw new Error(
      `Expected field to be an array or blocks type but got: ${field.type}`,
    );
  }
