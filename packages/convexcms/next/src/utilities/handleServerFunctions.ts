import type { ServerFunction, ServerFunctionHandler } from "@convexcms/core";
import { copyDataFromLocaleHandler } from "@convexcms/ui/rsc";
import { buildFormStateHandler } from "@convexcms/ui/utilities/buildFormState";
import { buildTableStateHandler } from "@convexcms/ui/utilities/buildTableState";
import { schedulePublishHandler } from "@convexcms/ui/utilities/schedulePublishHandler";
...
export const handleServerFunctions: ServerFunctionHandler = async (args) => {
  ...
  const serverFunctions = {
    ...
    "render-document-slots":
      renderDocumentSlotsHandler as any as ServerFunction,
