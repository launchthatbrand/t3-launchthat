...
export const RenderFields = props => {
  ...
  if (fields && fields.length > 0) {
    return /*#__PURE__*/_jsx(RenderIfInViewport, {
      className: [baseClass, className, margins && `${baseClass}--margins-${margins}`, margins === false && `${baseClass}--margins-none`].filter(Boolean).join(" "),
