...
const TabsFieldComponent = props => {
  ...
  const [activeTabIndex, setActiveTabIndex] = useState(() => tabStates.filter(({
    passesCondition
  }) => passesCondition)?.[0]?.index ?? 0);
  ...
  }, [tabs, parentPath, parentSchemaPath, getPreference, preferencesKey, setPreference, path, tabsPrefKey]);
  useEffect(() => {
    if (preferencesKey) {
  ...
  return /*#__PURE__*/_jsx("div", {
    className: [fieldBaseClass, className, baseClass, isWithinCollapsible && `${baseClass}--within-collapsible`, !hasVisibleTabs && `${baseClass}--hidden`].filter(Boolean).join(" "),
    children: /*#__PURE__*/_jsxs(TabsProvider, {
      children: [/*#__PURE__*/_jsx("div", {
        className: `${baseClass}__tabs-wrap`,
        children: /*#__PURE__*/_jsx("div", {
          className: `${baseClass}__tabs`,
          children: tabStates.map(({
            index,
            passesCondition,
            tab
        ...
        children: activeTabConfig && /*#__PURE__*/_jsx(TabContent, {
...
function TabContent({
  ...
  return /*#__PURE__*/_jsxs("div", {
    className: [hidden && `${baseClass}__tab--hidden`, `${baseClass}__tab`, label && `${baseClass}__tabConfigLabel-${toKebabCase(getTranslation(label, i18n))}`].filter(Boolean).join(" "),
