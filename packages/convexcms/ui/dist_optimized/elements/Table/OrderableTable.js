...
export const OrderableTable = ({
  ...
  if (!activeColumns || activeColumns.filter(col => !["_dragHandle", "_select"].includes(col.accessor)).length === 0) {
    ...
    children: /*#__PURE__*/_jsxs(DraggableSortable, {
      ...
      children: [/*#__PURE__*/_jsxs("table", {
        ...
        children: [/*#__PURE__*/_jsx("thead", {
          ...
          children: localData.map((row, rowIndex) => /*#__PURE__*/_jsx(DraggableSortableItem, {
            id: rowIds[rowIndex],
            children: ({
              attributes,
              isDragging,
