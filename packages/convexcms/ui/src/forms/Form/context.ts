...
import type {
  Context,
  FormFieldsContext as FormFieldsContextType,
} from "./types.js";
...
const FormFieldsContext = createSelectorContext<FormFieldsContextType>([
  {},
  () => null,
]);
...
const useFormBackgroundProcessing = (): boolean =>
  use(BackgroundProcessingContext);
...
const useAllFormFields = (): FormFieldsContextType =>
  useFullContext(FormFieldsContext);
