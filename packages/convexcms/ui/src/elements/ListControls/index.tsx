...
export const ListControls: React.FC<ListControlsProps> = (props) => {
  ...
  const searchLabel =
    (titleField &&
      getTranslation(
        "label" in titleField &&
          (typeof titleField.label === "string" ||
            typeof titleField.label === "object")
          ? titleField.label
          : "name" in titleField
            ? titleField.name
            : null,
  ...
  if (
    ...
    listMenuItems = [
      ...queryPresetMenuItems,
      listMenuItemsFromProps?.length > 0 ? (
        <PopupList.Divider key="divider" />
      ) : null,
    ...
    <Fragment>
      <div className={baseClass}>
        <div className={`${baseClass}__wrap`}>
          ...
          <SearchFilter
            fieldName={
              titleField && "name" in titleField ? titleField?.name : null
            }
            handleChange={(search) => {
