...
export const DocumentDrawerCallbacksContext = createContext(
  {} as DocumentDrawerContextType,
);
...
> = ({ children, ...rest }) => {
  return (
    <DocumentDrawerCallbacksContext value={rest}>
      {children}
    </DocumentDrawerCallbacksContext>
  );
};
...
export const useDocumentDrawerContext = (): DocumentDrawerContextType => {
  ...
  if (!context) {
    throw new Error(
      "useDocumentDrawerContext must be used within a DocumentDrawerProvider",
    );
  }
