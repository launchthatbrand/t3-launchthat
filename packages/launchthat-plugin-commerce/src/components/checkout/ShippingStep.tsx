...
import type { Id } from "../../lib/types"; // Import Id
...
export const ShippingStep = () => {
  ...
  const initiateCheckoutMutation = useCommerceMutation(
    commerceApi?.ecommerce?.checkout?.initiateCheckout ??
      commerceApi?.checkout?.initiateCheckout,
  );
  const updateShippingAddressMutation = useCommerceMutation(
    commerceApi?.ecommerce?.checkout?.updateShippingAddress ??
      commerceApi?.checkout?.updateShippingAddress,
  );
