...
function Button(_a) {
    ...
    var Comp = asChild ? radix_ui_1.Slot.Slot : "button";
    return ((0, jsx_runtime_1.jsx)(Comp, __assign({ "data-slot": "button", className: (0, utils_1.cn)((0, exports.buttonVariants)({ variant: variant, size: size, className: className })) }, props)));
}
