...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative rounded-full bg-neutral-200 p-2 backdrop-blur-sm dark:bg-neutral-800",
        ...
        backdropBlur &&
          "after:pointer-events-none after:absolute after:inset-0 after:h-full after:w-full after:backdrop-blur-lg after:content-['']",
        containerClassName,
      )}
      style={
        {
    ...
    >
      {/* Background layers are clipped to rounded container, but content can overflow */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-3xl">
        ...
        <GradientLayer
          ...
          springY={springY}
          gradientColor={
            gradientColors[1] ?? gradientColors[0] ?? "rgb(100, 150, 255)"
          }
          opacity={0.3}
          multiplier={0.7}
        />
        <GradientLayer
          ...
          springY={springY}
          gradientColor={
            gradientColors[2] ?? gradientColors[0] ?? "rgb(255, 200, 100)"
          }
          opacity={0.25}
          multiplier={1.2}
        />
