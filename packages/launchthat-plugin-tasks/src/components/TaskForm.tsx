...
export const TaskForm: React.FC<TaskFormProps> = ({
  ...
  if (!taskMutations?.createTask || !taskMutations?.updateTask) {
    throw new Error("Tasks API is missing task mutation references.");
  }
  ...
  const createTask = useTasksMutation(taskMutations.createTask);
