import type { CarouselItem as RawCarouselItem } from "@/components/groups/GroupHeaderCarousel";
import { create } from "zustand";
import { shallow } from "zustand/shallow";

type CarouselItem = RawCarouselItem & { id: string };

type CarouselItemUpdates = Partial<Omit<CarouselItem, "id">>;
...
interface CarouselState {
  ...
  updateItem: (id: string, updates: CarouselItemUpdates) => void;
