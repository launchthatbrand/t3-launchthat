...
export interface SocialHubDashboardProps {
  publicFeedUrl?: string;
  manageFeedUrl?: string;
  manageGroupsUrl?: string;
}

export function SocialHubDashboard({
  publicFeedUrl = "/social/feed",
  manageFeedUrl = "/admin/edit?post_type=social-feed-item",
  manageGroupsUrl = "/admin/edit?post_type=social-feed-group",
}: SocialHubDashboardProps) {
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Button asChild variant="outline">
            <Link href={publicFeedUrl} target="_blank">
              View Public Feed
            </Link>
          </Button>
        ...
        <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <Button asChild variant="outline" size="sm">
              <Link href={manageFeedUrl}>Manage Feed Items</Link>
            </Button>
            <Button asChild variant="outline" size="sm">
              <Link href={manageGroupsUrl}>Manage Social Groups</Link>
            </Button>
          </div>
        </CardHeader>
        <Separator />
