...
import type { EventFormValues, RecurrenceFormValues } from "./formSchema";
...
export function RecurrenceSelector() {
  ...
  const updateRecurrence = (update: Partial<RecurrenceFormValues>) => {
    const current = form.getValues("recurrence");
    form.setValue("recurrence", { ...current, ...update });
  };
                        ...
                        <FormItem className="flex items-center space-y-0 space-x-3">
                          ...
                          <FormLabel className="font-normal">
                            ...
                            <Input
                              ...
                              onClick={() =>
                                updateRecurrence({ endType: "after" })
                              }
