...
export async function GET(req: NextRequest) {
  ...
  const session: unknown = await convexAny.query(apiAny.auth.sessions.getTenantSessionByIdHash, {
    sessionIdHash,
  });
  ...
  void convexAny.mutation(apiAny.auth.sessions.touchTenantSession, {
    sessionIdHash,
  });
