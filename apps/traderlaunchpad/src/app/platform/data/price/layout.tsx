...
export default function PlatformDataLayout(props: { children: React.ReactNode }) {
  ...
  const activeTab = React.useMemo(() => {
    if (pathname.startsWith("/platform/data/price/logs")) return "logs";
    if (pathname.startsWith("/platform/data/price/sync")) return "sync";
    if (pathname.startsWith("/platform/data/price/compare")) return "compare";
    return "chart";
  }, [pathname]);
