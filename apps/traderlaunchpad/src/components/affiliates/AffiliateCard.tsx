      ...
      <div className="relative flex h-full flex-col">
        <div className="flex items-start gap-4">
          ...
          <div className="flex items-start gap-3">
            <Link
              href={detailsHref}
              className="min-w-0 flex-1 truncate text-base font-semibold text-white underline-offset-4 hover:underline"
            >
              {item.name}
            </Link>
            <AffiliateStars
          ...
          <div className="mt-1 line-clamp-2 text-sm leading-6 text-white/60">
            {item.tagline}
          </div>
          </div>
        </div>
        ...
        <div className="mt-auto pt-6">
          <div className="flex flex-wrap items-center gap-3">
            <Button
              asChild
              variant="outline"
              className="h-10 rounded-full border-white/15 bg-white/5 px-4 text-sm text-white hover:bg-white/10 hover:text-white"
            >
              {primary.external ? (
                <a
                  href={primary.href}
