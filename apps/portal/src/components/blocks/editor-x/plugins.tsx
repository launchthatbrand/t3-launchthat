...
import { MermaidPickerPlugin } from "~/components/editor/plugins/picker/mermaid-picker-plugin";
...
const SpeechToTextPlugin = dynamic(
  () =>
    import("~/components/editor/plugins/actions/speech-to-text-plugin").then(
            ...
            <div className="">
              <div className="" ref={onRef}>
                <ContentEditable
                  ...
                  className="ContentEditable__root relative block h-[600px] min-h-48 overflow-auto px-8 py-4 focus:outline-none"
                />
              </div>
            </div>
          }
