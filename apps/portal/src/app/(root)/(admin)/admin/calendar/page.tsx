...
import { CalendarSidebar } from "~/app/(root)/(frontend)/calendar/_components/CalendarSidebar";
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="mr-2 flex gap-1">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleViewChange("month" as View)}
                    >
                      Month
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleViewChange("week" as View)}
                    >
                      Week
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleViewChange("day" as View)}
                    >
                      Day
                    </Button>
                  </div>
...
function getDateRangeFromView(
  ...
  switch (view) {
    ...
    case "month":
      ...
      break;
    case "agenda":
      // For agenda view, use the same range as month
      startDate.setDate(1);
      endDate.setMonth(date.getMonth() + 1);
      endDate.setDate(0);
      endDate.setHours(23, 59, 59, 999);
