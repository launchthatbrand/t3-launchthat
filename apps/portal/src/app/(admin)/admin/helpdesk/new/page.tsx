...
export default function CreateHelpdeskArticlePage() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      // Generate the slug from the title to redirect to the new article
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold">Create Helpdesk Article</h1>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="E.g., How to manage user permissions"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                      The title will also be used to generate the article's URL.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        rows={2}
                        placeholder="A brief summary that will appear in search results and article listings"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        placeholder="<h2>Introduction</h2><p>Start with an introduction to the topic...</p>"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
