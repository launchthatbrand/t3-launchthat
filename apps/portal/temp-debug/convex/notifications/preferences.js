...
import { defaultAppPreferences, defaultEmailPreferences, getUserNotificationPreferences, } from "./lib/preferences";
/**
...
export const updateSingleNotificationPreference = mutation({
    args: {
        userId: v.id("users"),
        type: v.union(v.literal("friendRequest"), v.literal("friendAccepted"), v.literal("message"), v.literal("mention"), v.literal("groupInvite"), v.literal("groupJoinRequest"), v.literal("groupJoinApproved"), v.literal("groupJoinRejected"), v.literal("groupInvitation"), v.literal("invitationAccepted"), v.literal("invitationDeclined"), v.literal("groupPost"), v.literal("groupComment"), v.literal("eventInvite"), v.literal("eventReminder"), v.literal("eventUpdate"), v.literal("newDownload"), v.literal("courseUpdate"), v.literal("orderConfirmation"), v.literal("paymentSuccess"), v.literal("paymentFailed"), v.literal("productUpdate"), v.literal("systemAnnouncement")),
