...
export const permissionScopeTypeValidator = v.union(v.literal("global"), v.literal("group"), v.literal("course"), v.literal("organization"));
...
export const rolePermissionsTable = defineTable({
    ...
    level: v.union(v.literal("none"), v.literal("own"), v.literal("group"), v.literal("all")),
})
...
export const permissionAuditLogTable = defineTable({
    action: v.union(v.literal("role_assigned"), v.literal("role_removed"), v.literal("permission_granted"), v.literal("permission_revoked"), v.literal("role_created"), v.literal("role_updated"), v.literal("role_deleted")),
