 ...
 */
export const getAuthenticatedConvexId = async (ctx) => {
 ...
 */
export const hasCalendarAccess = async (ctx, calendarId, userId) => {
    // Get the calendar
    ...
    const permission = await ctx.db
        ...
        .withIndex("by_calendar_user", (q) => q.eq("calendarId", calendarId).eq("userId", userId))
        .unique();
    return !!permission;
};
/**
 ...
 */
export const hasCalendarWriteAccess = async (ctx, calendarId, userId) => {
    // Get the calendar
    const calendar = await ctx.db.get(calendarId);
    if (!calendar) {
        return false;
 ...
 */
export const hasCalendarAdminAccess = async (ctx, calendarId, userId) => {
    // Get the calendar
    const calendar = await ctx.db.get(calendarId);
    if (!calendar) {
        return false;
 ...
 */
export const verifyCalendarAccess = async (ctx, calendarId, userId) => {
 ...
 */
export const verifyCalendarWriteAccess = async (ctx, calendarId, userId) => {
 ...
 */
export const verifyCalendarAdminAccess = async (ctx, calendarId, userId) => {
