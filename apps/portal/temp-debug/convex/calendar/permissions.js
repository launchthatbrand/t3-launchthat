...
export const shareCalendar = mutation({
    args: {
        ...
        userId: v.id("users"),
        permissionType: v.union(v.literal("read"), v.literal("write"), v.literal("admin")),
    ...
    handler: async (ctx, args) => {
        ...
        const existingPermission = await ctx.db
            ...
            .withIndex("by_calendar_user", (q) => q.eq("calendarId", args.calendarId).eq("userId", args.userId))
            .first();
