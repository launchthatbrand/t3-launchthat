...
export const contactInteractionsTable = defineTable({
    ...
    type: v.union(v.literal("email"), v.literal("call"), v.literal("meeting"), v.literal("note"), v.literal("task"), v.literal("purchase")),
    subject: v.string(),
...
export const dealsTable = defineTable({
    ...
    stage: v.union(v.literal("prospecting"), v.literal("qualification"), v.literal("needs-analysis"), v.literal("proposal"), v.literal("negotiation"), v.literal("closed-won"), v.literal("closed-lost")),
