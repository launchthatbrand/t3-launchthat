...
export const contentRecommendationsTable = defineTable({
    ...
    reasonType: v.union(v.literal("topic"), v.literal("similarUser"), v.literal("engagement"), v.literal("trending"), v.literal("newContent")),
    ...
    userReaction: v.optional(v.union(v.literal("like"), v.literal("dislike"), v.literal("neutral"))),
})
