...
import { contentAccessLogTable, contentAccessRulesTable, } from "./contentAccess/schema";
// --- Courses Table ---
...
export const courseEnrollmentsTable = defineTable({
    ...
    status: v.optional(v.union(v.literal("active"), v.literal("completed"), v.literal("suspended"), v.literal("cancelled"))),
