...
export const groupsTable = defineTable({
    ...
    privacy: v.union(v.literal("public"), // Anyone can see and join
...
export const groupMembersTable = defineTable({
    groupId: v.id("groups"),
    userId: v.id("users"),
    role: v.union(v.literal("admin"), // Can manage group settings and members
    v.literal("moderator"), // Can moderate content and members
    v.literal("member")),
    status: v.union(v.literal("active"), v.literal("invited"), // Invited but not yet joined
...
export const groupActivityTable = defineTable({
    groupId: v.id("groups"),
    userId: v.id("users"),
    activityType: v.union(v.literal("view"), v.literal("post"), v.literal("comment"), v.literal("rsvp"), v.literal("join"), v.literal("invite")),
