 ...
 */
export function isInStock(product, quantity = 1) {
 ...
 */
export function isVariationInStock(variation, quantity = 1) {
 ...
 */
export async function decreaseProductStock(ctx, productId, quantity) {
 ...
 * @returns The new stock quantity
 */
export async function decreaseVariationStock(ctx, variationId, quantity) {
