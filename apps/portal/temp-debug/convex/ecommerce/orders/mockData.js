...
export const createMockOrder = mutation({
    ...
    handler: async (ctx) => {
        try {
            ...
            const updatedAt = createdAt + Math.floor(Math.random() * 24 * 60 * 60 * 1000); // Updated sometime after creation
            ...
            ctx.scheduler.runAfter(0, internal.integrations.triggers.orderEvents.triggerOrderCreated, {
                orderId: newOrderId,
